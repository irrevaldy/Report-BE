...
{
  public function listInactiveTIDFiltered(Request $request)
  {
    try
    {
      ...
      switch ($range)
      {
          case 'd':
              ...
              $filename = 'InactiveTID_'.$dateFile.'_'.$bankcode;
           ...
           case 'm':
              ...
              // {
              //   $filename = 'InactiveTIDReport_'.$i.'_'.$bankcode;
              ...
              $filename = 'InactiveTIDReport_'.$dateFile.'_'.$bankcode;
          ...
          case 'w':
              ...
              {
                $filename = 'InactiveTID_'.$i.'_'.$bankcode;
                //$filename = 'ReconsiliationReport_'.$i.'_'.$username;
                $fullFileName = $filename.$extFile;
                $fullPath = $dir.$filename.$extFile;
      ...
      foreach($arrselected as $key => $value)
      {
        ...
        if($reportType == 'InactiveTIDReport')
        {
          $arrgoodi[$num] = $goodi;
        }
        $num++;
