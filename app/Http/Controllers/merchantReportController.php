...
class merchantReportController extends Controller
{
  public function listByAcquirerFiltered(Request $request)
  {
    try
    {
      ...
      switch ($range)
      {
          case 'd':
           ...
           case 'm':
              ...
              foreach($merchant as $key => $value)
              {
                ...
                $filename = 'MerchantMonthlyRevenueByAcquirer_'.$dateFile.'_'.$merchanta;
                //$filename = 'ReconsiliationReport_'.$dateFile."_".$username;
          ...
          case 'y':
             ...
             foreach($merchant as $key => $value)
             {
               ...
               $filename = 'MerchantYearlyRevenueByAcquirer_'.$date.'_'.$merchanta;
               //$filename = 'ReconsiliationReport_'.$dateFile."_".$username;
      ...
      foreach($arrselected as $key => $value)
      {
        ...
        if($reportType == 'MerchantMonthlyRevenueByAcquirer' || $reportType == 'MerchantYearlyRevenueByAcquirer')
        {
          $arrgoodi[$num] = $goodi;
        }
        $num++;
  ...
  public function listByBranchFiltered(Request $request)
  {
    try
    {
      ...
      switch ($range)
      {
          case 'd':
           ...
           case 'm':
              ...
              foreach($merchant as $key => $value)
              {
                ...
                $filename = 'MerchantMonthlyRevenueByBranch_'.$dateFile.'_'.$merchanta;
                //$filename = 'ReconsiliationReport_'.$dateFile."_".$username;
          ...
          case 'y':
             ...
             foreach($merchant as $key => $value)
             {
               ...
               $filename = 'MerchantYearlyRevenueByBranch_'.$date.'_'.$merchanta;
               //$filename = 'ReconsiliationReport_'.$dateFile."_".$username;
      ...
      foreach($arrselected as $key => $value)
      {
        ...
        $goodi['size'] = $human_filesize."B";
        if($reportType == 'MerchantMonthlyRevenueByBranch' || $reportType == 'MerchantYearlyRevenueByBranch')
        {
          $arrgoodi[$num] = $goodi;
        }
        $num++;
  ...
  public function listTop10HighestBranchFiltered(Request $request)
  {
    try
    {
      ...
      switch ($range)
      {
          case 'd':
           ...
           case 'm':
              ...
              foreach($merchant as $key => $value)
              {
                ...
                $filename = 'MerchantMonthlyTop10HighestBranch_'.$dateFile.'_'.$merchanta;
                //$filename = 'ReconsiliationReport_'.$dateFile."_".$username;
          ...
          case 'y':
             ...
             foreach($merchant as $key => $value)
             {
               ...
               $filename = 'MerchantYearlyTop10HighestBranch_'.$date.'_'.$merchanta;
               //$filename = 'ReconsiliationReport_'.$dateFile."_".$username;
      ...
      foreach($arrselected as $key => $value)
      {
        ...
        $goodi['size'] = $human_filesize."B";
        if($reportType == 'MerchantMonthlyTop10HighestBranch' || $reportType == 'MerchantYearlyTop10HighestBranch')
        {
          $arrgoodi[$num] = $goodi;
        }
        $num++;
