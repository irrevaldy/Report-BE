...
class acquirerReportController extends Controller
{
  public function listByMerchantFiltered(Request $request)
  {
    try
    {
      ...
      switch ($range)
      {
          case 'd':
           ...
           case 'm':
              ...
              foreach($acquirer as $key => $value)
              {
                ...
                $filename = 'AcquirerMonthlyRevenueByMerchant_'.$dateFile.'_'.$acquirera;
                //$filename = 'ReconsiliationReport_'.$dateFile."_".$username;
          ...
          case 'y':
            ...
            foreach($acquirer as $key => $value)
            {
              ...
              $filename = 'AcquirerYearlyRevenueByMerchant_'.$date.'_'.$acquirera;
              //$filename = 'ReconsiliationReport_'.$dateFile."_".$username;
      ...
      foreach($arrselected as $key => $value)
      {
        ...
        if($reportType == 'AcquirerMonthlyRevenueByMerchant' || $reportType == 'AcquirerYearlyRevenueByMerchant')
        {
          $arrgoodi[$num] = $goodi;
        }
        $num++;
  ...
  public function listOnUsOffUsByMerchantFiltered(Request $request)
  {
    try
    {
      ...
      switch ($range)
      {
          case 'd':
           ...
           case 'm':
              ...
              foreach($acquirer as $key => $value)
              {
                ...
                $filename = 'AcquirerMonthlyOnUsOffUsByMerchant_'.$dateFile.'_'.$acquirera;
                //$filename = 'ReconsiliationReport_'.$dateFile."_".$username;
          ...
          case 'y':
            ...
            foreach($acquirer as $key => $value)
            {
              ...
              $filename = 'AcquirerYearlyOnUsOffUsByMerchant_'.$date.'_'.$acquirera;
              //$filename = 'ReconsiliationReport_'.$dateFile."_".$username;
      ...
      foreach($arrselected as $key => $value)
      {
        ...
        $goodi['size'] = $human_filesize."B";
        if($reportType == 'AcquirerMonthlyOnUsOffUsByMerchant' || $reportType == 'AcquirerYearlyOnUsOffUsByMerchant')
        {
          $arrgoodi[$num] = $goodi;
        }
        $num++;
