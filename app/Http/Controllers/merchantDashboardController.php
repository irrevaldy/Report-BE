...
class merchantDashboardController extends Controller
{
  ...
  public function getData(Request $request, $user_id)
  {
    ...
    //total terminal
    $q_get_total_summary = DB::select("spDWH_DashboardMerchantSummaryData '$username'");
    ...
    $q_get_onusoffus_trx = DB::select("spDWH_DashboardMerchantOnUsOffUs '$get_past1_month', '$get_current_month', '$username'");
  ...
  public function getTop5AcquirerTransactionVolume(Request $request, $user_id)
  {
    try
    {
      ...
      $q_get_top5_acquirer = DB::select("spDWH_DashboardMerchantTop5Acquirer '$get_past3_month', '$get_current_month', '$username'");
  ...
  public function getTop5BranchTransactionVolume(Request $request, $user_id)
  {
    try
    {
      //get user data
      ...
      $q_get_top5_branch = DB::select("spDWH_DashboardMerchantTop5Branch '$get_past3_month', '$get_current_month', '$username'");
      ...
      $data_top5branch_trx_volume = json_encode($data_top5branch_trx_volume);
      $data_top5branch_trx_volume = json_decode($data_top5branch_trx_volume, true);
  ...
  public function getTop5BranchTransactionCount(Request $request, $user_id)
  {
    try
    {
      //get user data
      ...
      $data_top5branch_trx_count = json_encode($data_top5branch_trx_count);
      $data_top5branch_trx_count = json_decode($data_top5branch_trx_count, true);
  ...
  public function getTop5StoreTransactionVolume(Request $request, $user_id)
  {
    try
    {
      ...
      $q_get_top5_store = DB::select("spDWH_DashboardMerchantTop5Store '$get_past3_month', '$get_current_month', '$username'");
  ...
  public function getTop5CardTypeTransactionVolume(Request $request, $user_id)
  {
    try
    {
      ...
      $q_get_top5_cardtype = DB::select("spDWH_DashboardMerchantTop5CardType '$get_past3_month', '$get_current_month', '$username'");
  ...
  public function getTop5TransactionTypeTransactionVolume(Request $request, $user_id)
  {
    try
    {
      ...
      $q_get_top5_trxtype = DB::select("spDWH_DashboardMerchantTop5TrxType '$get_past3_month', '$get_current_month', '$username'");
